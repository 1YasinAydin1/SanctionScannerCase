...
{
    public class ProgressPaymentCreateUpdateDto
    {
        ...
        public List<PozLineDto>? ERP_HAKEDISPOZLINECollection { get; set; }
        public List<PozDto>? ERP_HAKEDISPOZCollection { get; set; }
        public List<TutanakDto>? ERP_HAK_TUTANAKCollection { get; set; }
    }
}
